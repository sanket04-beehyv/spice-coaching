...
class CHWModuleAssignment(Base):
    __tablename__ = "chw_module_assignment"
    __table_args__ = (
        UniqueConstraint("module_id", "user_id", name="uq_module_assignment_user"),
        UniqueConstraint("module_id", "tenant_id", name="uq_module_assignment_tenant"),
        UniqueConstraint("module_id", "upazila", name="uq_module_assignment_upazila"),
    )
