...
LOCALE_REGISTRY: dict[str, LocaleMetadata] = {
    "bn": LocaleMetadata(
        ...
        symbol_verbalization_examples=(
            ...
            '`>=20` -> "20 বা তার বেশি"',
            '`<=20` -> "20 বা তার কম"',
            '`BP 140/90 mmHg` -> "BP 140 over 90 mmHg" (blood-pressure pair)',
            '`1/2 tablet` -> "অর্ধ ট্যাবলেট" (dose fraction, not division)',
        ),
    ...
    "hi": LocaleMetadata(
        ...
        symbol_verbalization_examples=(
            ...
            '`<=20` -> "20 या उससे कम"',
            '`BP 140/90 mmHg` -> "BP 140 over 90 mmHg" (blood-pressure pair)',
            '`1/2 tablet` -> "आधी गोली" (dose fraction, not division)',
        ),
    ...
    "ta": LocaleMetadata(
        ...
        symbol_verbalization_examples=(
            ...
            '`BP 140/90 mmHg` -> "BP 140 over 90 mmHg" (blood-pressure pair)',
            '`1/2 tablet` -> "அரை மாத்திரை" (dose fraction, not division)',
        ),
    ...
    "te": LocaleMetadata(
        ...
        symbol_verbalization_examples=(
            ...
            '`BP 140/90 mmHg` -> "BP 140 over 90 mmHg" (blood-pressure pair)',
            '`1/2 tablet` -> "సగం మాత్ర" (dose fraction, not division)',
        ),
    ...
    "en": LocaleMetadata(
        ...
        symbol_verbalization_examples=(
            ...
            '`<=20` -> "20 or less"',
            '`BP 140/90 mmHg` -> "BP 140 over 90 mmHg" (blood-pressure pair)',
            '`1/2 tablet` -> "half a tablet" (dose fraction, not division)',
        ),
...
LOCALIZED_SEARCH_METADATA_SYNONYM_FIELDS: tuple[str, ...] = ("synonyms",)
